...
class Db:
    ...
    def _get_connection(self):
        ...
        try:
            ...
            if e.errno == errorcode.ER_ACCESS_DENIED_ERROR:
                self._log("Something is wrong with your user name or password")
            elif e.errno == errorcode.ER_BAD_DB_ERROR:
                self._log("Database does not exist")
            else:
                self._log(e.msg)
    ...
    def create_db(self):
        ...
        try:
            ...
            self._log('Ошибка создания базы данных ' + self.db_name)
            self._log(str(e))
        finally:
            cursor.close()
            connection.close()
    ...
    def create_table(self, sql):
        ...
        try:
            ...
            self._log('Ошибка создания таблицы ' + sql)
            self._log(str(e))
        finally:
            cursor.close()
            connection.close()
